...
function addScaffoldRoutes(routerFile, options) {
  ...
  var newFileContent = routes
    ...
    .add(options.dasherizedModuleNamePlural + '/show', { path: ':' + options.underscoredModuleName + '_id' })
    .add(options.dasherizedModuleNamePlural + '/edit', { path: ':' + options.underscoredModuleName + '_id/edit' })
    .code();
